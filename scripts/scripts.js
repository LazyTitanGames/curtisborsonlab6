...
function recalculate() {
    ...
    let duration = parseFloat(document.getElementById("duration-text").innerHTML);
    ...
    console.log(costLabel, modelName, duration);
}
...
function changeModel()
{
    ...
    let modelName = modelTextElement.innerHTML;
